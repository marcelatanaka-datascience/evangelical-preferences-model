...
MAPEAMENTO_NOMES = {
    ...
    'ameaca_tipo_inst_x_GrupoEv': 'Ameaça institucional × Evangélico',
...
def preparar_dados(df):
    ...
    df_clean['ameaca_tipo_inst_x_GrupoEv'] = df_clean['ameaca_tipo_inst'] * df_clean['GrupoEv']
    print(f"    ✓ Ameaça institucional × Evangélico")
...
def criar_grafico_coeficientes(resultados_df, output_path):
    ...
    ordem_variaveis = [
        ...
        'Ameaça institucional × Evangélico',
        'Sexo (1=Masculino)',
        'Raça/Etnia (1=Branco)',
        'Escolaridade'
    ]
    ...
    ax.set_title('Modelo com Efeito da Ameaça × Evangélico', 
...
def main():
    """Função principal."""
    print("="*70)
    print("MODELO COM EFEITO DA AMEAÇA × EVANGÉLICO")
    print("="*70)
    print("\nModelo teórico:")
    ...
    vars_independentes = [
        ...
        # Interação
        'ameaca_tipo_inst_x_GrupoEv',  # β₁: Ameaçai × GrupoEvi
        # Controles
        'dummy_sex',      # γ₁: Sexo
    ...
    # Salvar resultados
    output_coef = BASE_DIR / 'resultados_modelo_ameaca_interacao_coeficientes.csv'
    output_stats = BASE_DIR / 'resultados_modelo_ameaca_interacao_estatisticas.csv'
    output_grafico = BASE_DIR / 'grafico_coeficientes_modelo_ameaca_interacao.png'
