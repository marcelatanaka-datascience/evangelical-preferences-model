...
def criar_grafico_coeficientes(resultados_df, output_path):
    ...
    ax.set_title('Modelo com Efeito da Ameaça Moral', 
...
def main():
    """Função principal."""
    print("="*70)
    print("MODELO COM EFEITO DA AMEAÇA MORAL")
    print("="*70)
    print("\nModelo teórico:")
    ...
    # Salvar resultados
    output_coef = BASE_DIR / 'resultados_modelo_ameaca_moral_coeficientes.csv'
    output_stats = BASE_DIR / 'resultados_modelo_ameaca_moral_estatisticas.csv'
    output_grafico = BASE_DIR / 'grafico_coeficientes_modelo_ameaca_moral.png'
