"""
Script para testar o modelo com efeito do ANO da pesquisa
segundo a teoria proposta na tese.

Modelo teórico:
Yi = β₀ + (ModeloBase) + β₆Ano_t + γXi + εi
...
def criar_grafico_coeficientes(resultados_df, output_path):
    ...
    ax.set_title('Modelo com Efeito do Ano da Pesquisa', 
...
def main():
    """Função principal."""
    print("="*70)
    print("MODELO COM EFEITO DO ANO DA PESQUISA")
    print("="*70)
    print("\nModelo teórico:")
    print("Yi = β₀ + (ModeloBase) + β₆Ano_t + γXi + εi")
    print("\nEstimação: OLS com erros robustos de Huber-White (HC3)")
    print("="*70)
    ...
    # Salvar resultados
    output_coef = BASE_DIR / 'resultados_modelo_ano_coeficientes.csv'
    output_stats = BASE_DIR / 'resultados_modelo_ano_estatisticas.csv'
    output_grafico = BASE_DIR / 'grafico_coeficientes_modelo_ano.png'
